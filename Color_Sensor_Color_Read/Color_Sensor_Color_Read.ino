...
int SensorOut=8;    // asign Color Sensor OUT pin to Arduino pin 8
...
unsigned int pulseWidth; // 'int' assigns 0-255. For bigger no's we use 'unsigned int' up to 102,400! 
                         //  as the clor sensor sends a reading of numbers up to 102,400!
